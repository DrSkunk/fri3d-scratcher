...
export function Pad({
  ...
  return (
    <button
      ...
      className={`flex w-full flex-col items-center justify-center rounded-md border-4 border-black px-2 py-3 font-display font-bold uppercase transition-transform active:translate-x-1 active:translate-y-1 active:shadow-none ${press} ${fill}`}
    >
